        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Model = table.Column<string>(maxLength: 70, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassportNumber = table.Column<string>(maxLength: 150, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 50, nullable: false),
                    IATA = table.Column<string>(maxLength: 3, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartAirportId = table.Column<int>(nullable: false),
                    ArriveAirportId = table.Column<int>(nullable: false),
                    DepartDate = table.Column<DateTime>(nullable: false),
                    ArriveDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightLegs", x => new { x.FlightId, x.Direction, x.LegNumber });
                    table.ForeignKey(
                        name: "FK_FlightLegs_AirLines_AirLineId",
                        column: x => x.AirLineId,
                        principalTable: "AirLines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlightLegs_AirplaneModels_AirplaneModelId",
                        column: x => x.AirplaneModelId,
                        principalTable: "AirplaneModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlightLegs_Airports_ArriveAirportId",
                        column: x => x.ArriveAirportId,
                        principalTable: "Airports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlightLegs_Airports_DepartAirportId",
                        column: x => x.DepartAirportId,
                        principalTable: "Airports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightLegs_AirLineId",
                table: "FlightLegs",
                column: "AirLineId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightLegs_AirplaneModelId",
                table: "FlightLegs",
                column: "AirplaneModelId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightLegs_ArriveAirportId",
                table: "FlightLegs",
                column: "ArriveAirportId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightLegs_DepartAirportId",
                table: "FlightLegs",
                column: "DepartAirportId");
